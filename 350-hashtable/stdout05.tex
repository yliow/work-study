...
};\draw (1.0, -0.25) node[color=black] {\texttt{}};
\draw (1.0, -0.75)
  node[draw, line width=0.04cm, , color=black,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (1.0, -0.75) node[color=black] {\texttt{}};
\draw (1.0, -1.25)
  node[draw, line width=0.04cm, , color=black,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (1.0, -1.25) node[color=black] {\texttt{}};
\draw (1.0, -1.75)
  node[draw, line width=0.04cm, , color=black,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (1.0, -1.75) node[color=black] {\texttt{}};
\draw (1.0, -2.25)
  node[draw, line width=0.04cm, , color=black,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (1.0, -2.25) node[color=black] {\texttt{Tom}};
\draw (1.0, -2.75)
  node[draw, line width=0.04cm, , color=black,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (1.0, -2.75) node[color=black] {\texttt{Abe}};
\draw (1.0, -3.25)
  node[draw, line width=0.04cm, , color=black,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (1.0, -3.25) node[color=black] {\texttt{}};
\draw (1.0, -3.75)
  node[draw, line width=0.04cm, , color=black,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (1.0, -3.75) node[color=black] {\texttt{}};
\draw (1.0, -4.25)
  node[draw, line width=0.04cm, , color=black,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (1.0, -4.25) node[color=black] {\texttt{}};
\draw (1.0, -4.75)
  node[draw, line width=0.04cm, , color=black,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (1.0, -4.75) node[color=black] {\texttt{}};\draw[line width=0.05cm,black] (1.98,0.020000000000000018) to  (2.52,-0.52);
...
};\draw (5.0, -1.975) node[color=black] {\texttt{5.5}};\draw[line width=0.05cm,black,->] (2.25,-2.25) to  (4.23,-1.9749999999999999);

\fill[black] (2.25, -2.25) circle (0);
\draw[black] (2.25, -2.25) circle (0.0);
\draw (5.0, -3.0)
  node[draw, line width=0.04cm, , color=black,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (5.0, -3.0) node[color=black] {\texttt{6.5}};\draw[line width=0.05cm,black,->] (2.25,-2.75) to  (4.23,-3.0);

\fill[black] (2.25, -2.75) circle (0);
\draw[black] (2.25, -2.75) circle (0.0);\draw[line width=0.05cm,black] (1.98,-2.98) to  (2.52,-3.52);
