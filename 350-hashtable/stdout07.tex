...
};\draw (3.55, -2.9000000000000004) node[color=black] {{\texttt{false}}};
...
};\draw (9.05, -4.7) node[color=black] {{\texttt{}}};\draw[line width=0.04cm,black,->] (0.99,-2.4) to  (0.49,-2.4) to  (0.49,-2.8) to  (0.99,-2.8);
\end{tikzpicture}
