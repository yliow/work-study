...
};\draw (5.25, -1.975) node[color=black] {\texttt{Tom}};
\draw (7.0, -1.975)
  node[draw, line width=0.04cm, , color=black,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (7.0, -1.975) node[color=black] {\texttt{5.5}};\draw[line width=0.05cm,black,->] (2.25,-2.25) to  (4.25,-1.9749999999999999);
...
};\draw (5.25, -3.0) node[color=black] {\texttt{Abe}};
\draw (7.0, -3.0)
  node[draw, line width=0.04cm, , color=black,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (7.0, -3.0) node[color=black] {\texttt{6.5}};\draw[line width=0.05cm,black,->] (2.25,-2.75) to  (4.25,-3.0);
