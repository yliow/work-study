...
# - name of file
contents = [(at.OTHER, "../../courses/ciss240/a/a04/objective.tex"),
            (at.LATEXSTR, r"\newpage"),
            (at.OTHER, "../../courses/ciss240/a/a04/instructions.tex"),
            (at.LATEXSTR, r"\newpage"),
            (at.QUEST_CODE, "../../courses/ciss240/a/a04/a04q01/question/main.tex"),
            (at.LATEXSTR, r"\newpage"),
            (at.QUEST_CODE, "../../courses/ciss240/a/a04/a04q02/question/main.tex"),
            (at.LATEXSTR, r"\newpage"),
            (at.QUEST_CODE, "../../courses/ciss240/a/a04/a04q03/question/main.tex"),
            (at.LATEXSTR, r"\newpage"),
            (at.QUEST_CODE, "../../courses/ciss240/a/a04/a04q04/question/main.tex"),
            (at.LATEXSTR, r"\newpage")
            ]
###########################################################################
