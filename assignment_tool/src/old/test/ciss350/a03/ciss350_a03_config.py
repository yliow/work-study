...
# - name of file
contents = [(at.QUEST_CODE, "../../courses/ciss350/a/a03/questions/q01.tex"),
            (at.LATEXSTR, r"\newpage"),
            (at.QUEST_CODE, "../../courses/ciss350/a/a03/questions/q02.tex"),
            (at.LATEXSTR, r"\newpage"),
            (at.QUEST_CODE, "../../courses/ciss350/a/a03/questions/q03.tex"),
            (at.LATEXSTR, r"\newpage"),
            (at.QUEST_CODE, "../../courses/ciss350/a/a03/questions/q04.tex"),
            (at.LATEXSTR, r"\newpage")
            ]
###########################################################################
