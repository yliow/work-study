...
# - name of file
contents = [(at.OTHER, "../../courses/ciss240/a/a02/objective.tex"),
            (at.LATEXSTR, r"\newpage"),
            (at.OTHER, "../../courses/ciss240/a/a02/instructions.tex"),
            (at.LATEXSTR, r"\newpage"),
            (at.QUEST_CODE, "../../courses/ciss240/a/a02/a02q01/question/main.tex"),
            (at.LATEXSTR, r"\newpage"),
