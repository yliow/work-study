...
\fill[black] (1.5, 1.75) circle (0.08);
\draw[black] (1.5, 1.75) circle (0.08);
\node[anchor=south west] at (1.58,1.83)   {$a + bi$};

\node[anchor=north] at (1.5,0)   {$a$};

\node[anchor=east] at (0,1.75)   {$b$};
\draw[line width=0.04cm,black,,dashed] (0,1.75) to  (1.5,1.75);
\draw[line width=0.04cm,black,,dashed] (1.5,0) to  (1.5,1.75);
\end{tikzpicture}
