...
\node [line width=0.03cm,black,minimum size=0.6699999999999999cm,draw,circle] at (-2.38,-3.0)(3){};\draw (-2.38, -3.0) node[color=black] {\texttt{3}};\draw[line width=0.03cm,black] (10) to  (5);
\draw[line width=0.03cm,black] (10) to  (8);
\draw[line width=0.03cm,black] (5) to  (0);
\draw[line width=0.03cm,black] (5) to  (2);
\draw[line width=0.03cm,black] (8) to  (4);
\draw[line width=0.03cm,black] (8) to  (6);
\draw[line width=0.03cm,black] (0) to  (1);
