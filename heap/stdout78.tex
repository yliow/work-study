...
\node [line width=0.03cm,black,minimum size=0.6699999999999999cm,draw,circle] at (0.0,0.0)(3){};\draw (0.0, 0.0) node[color=black] {\texttt{3}};
...
\node [line width=0.03cm,black,minimum size=0.6699999999999999cm,draw,circle] at (-2.38,-3.0)(9){};\draw (-2.38, -3.0) node[color=black] {\texttt{9}};\draw[line width=0.03cm,black] (3) to  (1);
\draw[line width=0.03cm,black] (3) to  (2);
\draw[line width=0.03cm,black] (1) to  (0);
...
\fill[red!10] (-0.95, -2.0) circle (0.35);
\draw[line width=0.03cm,black] (-0.95, -2.0) circle (0.33499999999999996);\draw (-0.95, -2.0) node[color=black] {4};\draw[line width=0.1cm,white] (0) to  (9);
