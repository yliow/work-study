...
%print_single_quote_in_string exercise
\begin{ex}
...
%print_backslash exercise
\begin{ex}
Write a program that print the backslash character, i.e. \verb!\!.
\qed
\end{ex}
%print_double_quotes_in_string exercise
\begin{ex}
Write a program that prints this:
\begin{console}
...
%print_code_helloworld exercise
\begin{ex}
Write a program that prints this:
\begin{console}
#include <iostream>
...
%printing_multiple_strings exercise
\begin{ex}
...
%combining_print_statements exercise
\begin{ex}
