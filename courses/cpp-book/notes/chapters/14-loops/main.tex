...
\input{../exercises/0-14-loops/question.tex}\input{../exercises/1-14-loops/question.tex}\newpage\EMPHASIZE{Example: sentinel value}
...
\input{../exercises/8-14-loops/question.tex}
...
\input{../exercises/19-14-loops/question.tex}This is correct but we can simplify the code. Look at the previous
simulation:
...
\input{../exercises/20-14-loops/question.tex}In other words, if you repeat the above algorithm, the sequence of
