...
{                      
public:
    |Int (int x = 0)\tikzmark{i}| |\xsidebox[-6cm][0cm]{f}{\textnormal{1. Forced to have a default constructor.}}| |\DrawArrowH{f}{i}|  
        : x_(x) {}
    void set(int a)    
    {
        x_ = a;        
...
{               
    |Int a[10];\tikzmark{a}|
    for (int i = 0; i < 10; ++i)
        |a[i].set(i);\tikzmark{i}||\xsidebox[-6cm][4cm]{s}{\textnormal{3. set each object.}}||\DrawArrow{s}{i}|
