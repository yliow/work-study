...
\begin{tikzpicture}
    ...
    \draw[->,ultra thick] (formemnode.south) to (fora.north);
...
\begin{tikzpicture}
    ...
    \node[draw,text width=4cm,minimum height=6cm,minimum width=3cm, line width=0.05cm, inner sep=0.3cm,yshift=-3.5cm] (for3a) at (fora.south) {};
    \node[draw,text width=2cm,minimum height=1cm,line width=0.01cm,yshift=-8mm] (for3xbox) at (for3a.north){\normalsize{\texttt{\ \ \ \ \ \ \ \ \ }\textbf{42}}};
    ...
    \node[draw,text width=2.7cm,line width=0.03cm,minimum height=1.5cm] (for3abox) at (for3ybox.center) {};
    \node[draw,yshift=-12mm,text width=3.5cm, line width=0.03cm,minimum height=3.2cm] (for3bbox) at (for3a.center) {};
    ...
    \node[yshift=-10mm,xshift=-15mm] (for3memnode) at (for3a.south east){\normalsize{Memory of \textbf{body} of for-loop}};
    \draw[->,ultra thick] (for3memnode.north) to (for3abox.south east);
...
\begin{tikzpicture}
    ...
    \node[draw,text width=4cm,minimum height=2.5cm,minimum width=4cm, line width=0.04cm, yshift=-0.5cm] (for5a2) at (for5a) {};
    \node[draw,text width=3cm,minimum height=1.4cm,minimum width=3cm, line width=0.03cm] (for5ybox2) at (for5ybox) {};
    ...
    \node[xshift=1.5cm,yshift=-1cm] (for5whilebdynode) at (for5a.south) {\normalsize{body of while-loop}};
...
\begin{ex} Now look at the example from the previous section.
Why is
