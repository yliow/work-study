\newpage\EMPHASIZE{20. Array Parameters}
...
\newpage\EMPHASIZE{Array parameters}
...
\newpage\EMPHASIZE{Modification of values in an array through a function}
...
\newpage\EMPHASIZE{Bubblesort and binary search}
...
\newpage\EMPHASIZE{Computing array sizes: \texttt{sizeof()}}
...
\newpage\EMPHASIZE{Arrays and operators}
...
\newpage\EMPHASIZE{Standard operations on arrays}
...
\begin{ex}
Find a way to iterate through all possible sets of CA rules. For each set of rules, find the number of steps for the ca to repeat itself. [Challenging: Read the section on BINARY NUMBERS]
\begin{ex}
