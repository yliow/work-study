...
\newpage\input{timing.tex}
\newpage\input{what-is-asymptotic-analysis.tex} 
\newpage\input{roots-of-asymptotics.tex} 
\newpage\input{algorithm-analysis-how-fast-is-an-algorithm.tex}
\newpage\input{best-average-and-worst-time.tex} 
\newpage\input{separating-polynomial-functions.tex} 
\newpage\input{definition-of-big-O.tex} 
\newpage\input{summation.tex}
\newpage\input{formulas-for-sum-of-powers.tex} 
\newpage\input{bubblesort.tex}
...
\newpage\input{other-types-of-asymptotic-bounds.tex}
%\end{comment}

\newpage\input{function-call.tex}
\newpage\input{recursive-function-call.tex}
\newpage\input{linear-recursion.tex}
\newpage\input{linear-recursive-runtime.tex}
\newpage\input{fast-linear-recursion.tex}
%\newpage\input{floor-ceiling.tex}

%\begin{comment}  
\newpage\input{divide-and-conquer.tex}
\newpage\input{master-theorem.tex}
%\end{comment}
