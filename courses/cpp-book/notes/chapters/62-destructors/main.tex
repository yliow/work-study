...
\textbf{automatically called} when an object is about to be destroyed (i.e., about to
go out of scope):
...
class. This is the \textbf{default destructor}. The default destructor
...
allocate memory but set the \textbf{relevant pointer} to NULL.
