...
\input{../exercises/1-73-stl-vector-class/question.tex}\input{../exercises/2-73-stl-vector-class/question.tex}\newpage\EMPHASIZE{2D arrays}
...
\input{../exercises/3-73-stl-vector-class/question.tex}\input{../exercises/4-73-stl-vector-class/question.tex}\input{../exercises/5-73-stl-vector-class/question.tex}\input{../exercises/6-73-stl-vector-class/question.tex}\newpage\EMPHASIZE{References}
