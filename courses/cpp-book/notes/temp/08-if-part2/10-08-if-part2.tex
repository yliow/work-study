...
\input{exercises/14-08-if-part2/main.tex}Here's another example. Run this with inputs 1, 2, 3,
-1.
...
\input{exercises/15-08-if-part2/main.tex}By the way look at this program:
\begin{console}
if (score < 100)
{
...
\input{exercises/16-08-if-part2/main.tex}\input{exercises/17-08-if-part2/main.tex}
