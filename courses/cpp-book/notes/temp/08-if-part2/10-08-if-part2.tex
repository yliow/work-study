...
\input{temp/08-if-part2/exercises/14-08-if-part2/question.tex}Here's another example. Run this with inputs 1, 2, 3,
-1.
...
\input{temp/08-if-part2/exercises/15-08-if-part2/question.tex}By the way look at this program:
\begin{console}
if (score < 100)
{
...
\input{temp/08-if-part2/exercises/16-08-if-part2/question.tex}\input{temp/08-if-part2/exercises/17-08-if-part2/question.tex}
