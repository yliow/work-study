...
%\textbf{Exercise.} 
\input{temp/08-if-part2/exercises/0-08-if-part2/question.tex}
...
\input{temp/08-if-part2/exercises/1-08-if-part2/question.tex}Rewrite the program using if-else.

\input{temp/08-if-part2/exercises/2-08-if-part2/question.tex}Here's another:
\begin{console}[commandchars=\~\@\$]
gimme an int ~textbf@~underline@35$$
odd!!!
\end{console}

\input{temp/08-if-part2/exercises/3-08-if-part2/question.tex}Here's another
\begin{console}[commandchars=\~\@\$]
~textbf@3.4 23.4$
...
\textbf{Exercise.}
\input{temp/08-if-part2/exercises/4-08-if-part2/question.tex}
