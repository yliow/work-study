...
\end{python0}
\input{exercises/24-08-if-part2/main.tex}\sectionthree{The ternary operator}
...
\input{exercises/25-08-if-part2/main.tex}
\input{exercises/26-08-if-part2/main.tex}
\input{exercises/27-08-if-part2/main.tex}
