\tinysidebar{\debug{exercises/{4-24-default-values/question.tex}}}You are a programmer for Wal-art (they sell art supplies ...). Your boss told you to write a function to compute weekly pay. Write a function \texttt{getSalary()} that accepts the number of hours (as a double) and computes the wage using this formula:
