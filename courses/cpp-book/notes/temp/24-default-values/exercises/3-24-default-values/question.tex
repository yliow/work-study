\tinysidebar{\debug{exercises/{3-24-default-values/question.tex}}}Write a \texttt{randrange()} function that accepts integers a and b and returns a random integer n such that a <= n < b. Test your code with this:
