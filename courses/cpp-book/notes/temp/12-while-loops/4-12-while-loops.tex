...
\end{python0}
<<<<<<< HEAD
\input{../exercises/3-12-while-loops/question.tex}\input{../exercises/4-12-while-loops/question.tex}\input{../exercises/5-12-while-loops/question.tex}\input{../exercises/6-12-while-loops/question.tex}\sectionthree{break}
=======
\sectionthree{break}
>>>>>>> parent of 3043c95 (.)
