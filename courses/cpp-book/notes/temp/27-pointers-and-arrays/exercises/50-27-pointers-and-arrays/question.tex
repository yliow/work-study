\tinysidebar{\debug{exercises/{50-27-pointers-and-arrays/question.tex}}}Write a program that implements a queue of integers using dynamic arrays. Test it thoroughly! You can test your queue implementation with the following:
