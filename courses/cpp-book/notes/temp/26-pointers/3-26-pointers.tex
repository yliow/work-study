...
\input{exercises/6-26-pointers/main.tex}
\input{exercises/7-26-pointers/main.tex}You \EMPHASIZE{cannot} initialize a pointer with the pointer value of a \EMPHASIZE{different type}.

\input{exercises/8-26-pointers/main.tex}
...
\input{exercises/9-26-pointers/main.tex}Declare a \texttt{char} pointer, say call it \texttt{p}, that points to the
