...
\input{temp/26-pointers/exercises/6-26-pointers/question.tex}
\input{temp/26-pointers/exercises/7-26-pointers/question.tex}You \EMPHASIZE{cannot} initialize a pointer with the pointer value of a \EMPHASIZE{different type}.

\input{temp/26-pointers/exercises/8-26-pointers/question.tex}
...
\input{temp/26-pointers/exercises/9-26-pointers/question.tex}Declare a \texttt{char} pointer, say call it \texttt{p}, that points to the
