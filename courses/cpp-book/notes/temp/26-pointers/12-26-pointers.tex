...
\end{python0}
\input{temp/26-pointers/exercises/56-26-pointers/question.tex}\input{temp/26-pointers/exercises/57-26-pointers/question.tex}\input{temp/26-pointers/exercises/58-26-pointers/question.tex}\sectionthree{Connection between pointers and references}
