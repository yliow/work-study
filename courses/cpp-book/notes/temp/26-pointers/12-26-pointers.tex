...
\end{python0}
\input{exercises/56-26-pointers/main.tex}\input{exercises/57-26-pointers/main.tex}\input{exercises/58-26-pointers/main.tex}\sectionthree{Connection between pointers and references}
