...
\end{python0}
\input{temp/73-stl-vector-class/exercises/1-73-stl-vector-class/question.tex}\input{temp/73-stl-vector-class/exercises/2-73-stl-vector-class/question.tex}\sectionthree{2D arrays}
