...
\input{../exercises/0-68-array-of-objects/question.tex}Suppose we have the following class:
...
\input{../exercises/1-68-array-of-objects/question.tex}In this example, the array has fixed sizes, and you loose control over
...
\input{../exercises/3-68-array-of-objects/question.tex}Now we want the row and column sizes to be dynamic \EMPHASIZE{and} the values in the array to be pointers so that we can call the constructor for each pointer \ldots
...
\input{../exercises/5-68-array-of-objects/question.tex}\input{../exercises/6-68-array-of-objects/question.tex}\input{../exercises/7-68-array-of-objects/question.tex}
