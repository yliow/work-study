...
\input{exercises/0-68-array-of-objects/main.tex}Suppose we have the following class:
...
\input{exercises/1-68-array-of-objects/main.tex}In this example, the array has fixed sizes, and you loose control over
...
delete [] a;
\end{console}
\input{exercises/2-68-array-of-objects/main.tex}
\input{exercises/3-68-array-of-objects/main.tex}Now we want the row and column sizes to be dynamic \EMPHASIZE{and} the values in the array to be pointers so that we can call the constructor for each pointer \ldots
...
print(p)
\end{python}
\input{exercises/4-68-array-of-objects/main.tex}
\input{exercises/5-68-array-of-objects/main.tex}\input{exercises/6-68-array-of-objects/main.tex}\input{exercises/7-68-array-of-objects/main.tex}
