...
\end{python0}
\input{exercises/2-17-one-dimensional-arrays/main.tex}\sectionthree{Declaring an array with initialization}
...
\input{exercises/3-17-one-dimensional-arrays/main.tex}
