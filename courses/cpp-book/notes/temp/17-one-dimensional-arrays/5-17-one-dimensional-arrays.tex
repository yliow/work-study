...
\end{python0}
\input{temp/17-one-dimensional-arrays/exercises/8-17-one-dimensional-arrays/question.tex}\sectionthree{The [ ] operator}
...
\end{consolethree}
\input{temp/17-one-dimensional-arrays/exercises/9-17-one-dimensional-arrays/question.tex}
