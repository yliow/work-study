...
\input{temp/14-loops/exercises/19-14-loops/question.tex}This is correct but we can simplify the code. Look at the previous
simulation:
...
\input{temp/14-loops/exercises/20-14-loops/question.tex}In other words, if you repeat the above algorithm, the sequence of
