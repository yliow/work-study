...
\end{python0}
\input{exercises/0-14-loops/main.tex}\input{exercises/1-14-loops/main.tex}\sectionthree{Example: sentinel value}
...
\input{exercises/2-14-loops/main.tex}\input{exercises/3-14-loops/main.tex}\input{exercises/4-14-loops/main.tex}\input{exercises/5-14-loops/main.tex}Of course for a real business application, the POS register would be
