...
\newpage
\input{exercises/2-16-scope/main.tex}In this case when the variable \texttt{a} in the inner if-statement is created, we say that the innermost \texttt{a} \EMPHASIZE{hides} the outer \texttt{a}.

\input{exercises/3-16-scope/main.tex}
\input{exercises/4-16-scope/main.tex}
