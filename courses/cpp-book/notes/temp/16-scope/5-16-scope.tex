...
\end{python0}
\input{temp/16-scope/exercises/5-16-scope/question.tex}\input{temp/16-scope/exercises/6-16-scope/question.tex}\sectionthree{Principle of minimal scope}
...
\input{temp/16-scope/exercises/7-16-scope/question.tex}For our program above you should be able to see these steps:
...
\input{temp/16-scope/exercises/8-16-scope/question.tex}
