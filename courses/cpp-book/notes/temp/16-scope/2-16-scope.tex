...
\input{temp/16-scope/exercises/0-16-scope/question.tex}If you need \textbf{several} temporary variables in a \texttt{for}-loop
you can do this:
...
\input{temp/16-scope/exercises/1-16-scope/question.tex}%\sectionthree{} requires solutions.tex, skipping for now
