...
\input{exercises/0-16-scope/main.tex}If you need \textbf{several} temporary variables in a \texttt{for}-loop
you can do this:
...
\input{exercises/1-16-scope/main.tex}%\sectionthree{} requires solutions.tex, skipping for now
