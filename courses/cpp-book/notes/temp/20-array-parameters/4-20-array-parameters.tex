...
The amount of memory (in terms of bytes - i.e. 8 bits) used by a value, a variable, or a type can be found by calling the \texttt{sizeof()} function.
...
\begin{center}
\texttt{sizeof(int) sizeof(1) sizeof(x)}
\end{center}
...
Here' s a useful application of the \texttt{sizeof()} function. Suppose you have an array of integers and you want to compute \textbf{the size of the array}. You can do this:
