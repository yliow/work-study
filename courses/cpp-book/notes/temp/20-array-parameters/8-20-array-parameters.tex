...
A \textbf{cellular automata (CA)} is simply a grid of values where the value at a point in the grid can change its value. The way such a value v changes depends on the values near v.
...
\input{temp/20-array-parameters/exercises/19-20-array-parameters/question.tex}
\input{temp/20-array-parameters/exercises/20-20-array-parameters/question.tex}
\input{temp/20-array-parameters/exercises/21-20-array-parameters/question.tex}
