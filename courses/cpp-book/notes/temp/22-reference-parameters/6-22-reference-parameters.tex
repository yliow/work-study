...
\input{exercises/7-22-reference-parameters/main.tex}\sidenote
{
\begin{tikzpicture}
...
\input{exercises/8-22-reference-parameters/main.tex}
...
\input{exercises/9-22-reference-parameters/main.tex}
...
\input{exercises/10-22-reference-parameters/main.tex}
Rules, rules, rules ... \EMPHASIZE{The type of a reference must match the type it's referring to}.

\input{exercises/11-22-reference-parameters/main.tex}
\input{exercises/12-22-reference-parameters/main.tex}
\input{exercises/13-22-reference-parameters/main.tex}
\input{exercises/14-22-reference-parameters/main.tex}
\input{exercises/15-22-reference-parameters/main.tex}
...
\input{exercises/16-22-reference-parameters/main.tex}
\input{exercises/17-22-reference-parameters/main.tex}
