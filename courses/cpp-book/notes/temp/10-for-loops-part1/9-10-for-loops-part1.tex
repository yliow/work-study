...
\input{exercises/31-10-for-loops-part1/main.tex}
\input{exercises/32-10-for-loops-part1/main.tex}What is the output? Now run the program with your C++ compiler and
verify.

\input{exercises/33-10-for-loops-part1/main.tex}
What is the output? Now run the program with your C++ compiler and
verify.

\input{exercises/34-10-for-loops-part1/main.tex}What is the output (or is there an error)? Now run the program with your
