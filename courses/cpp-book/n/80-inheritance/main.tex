...
std::cout \textless\textless{} "aCar has "

\textless\textless{} aCar.numWheels() \textless\textless{} "
wheels\textbackslash n";

std::cout \textless\textless{} "aMotorcycle has "

\textless\textless{} aMotorcycle.numWheels()

\textless\textless{} " wheels\textbackslash n";
...
Rect rect(9, 10, 11, 12, 0, 255, 0);\strut
\end{minipage}\tabularnewline
\bottomrule
\end{longtable}
...
void f0() \{ std::cout \textless\textless{} x\_ \textless\textless{}
'\textbackslash n'; \}
...
void f1() \{ std::cout \textless\textless{} x\_ \textless\textless{}
'\textbackslash n'; \}
