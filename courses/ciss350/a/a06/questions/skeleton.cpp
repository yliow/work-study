...
int main(int argc, char * argv[])
{
    ...
    //-------------------------------------------------------------------------
    // Call your sorting algorithm to sort x a total of k time and with
    // ascending=true and verbose=true - see questions later for "ascending"
    // and "verbose" parameter.
    //-------------------------------------------------------------------------
    ...
    //-------------------------------------------------------------------------
    int p = 0;
    // Assign to p the integer value from the numeric string argv[4]
    // If p is 1, print the average runtime.
