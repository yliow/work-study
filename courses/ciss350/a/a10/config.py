...
contents = [(at.OTHER, "Old/objectives.tex"),
            ...
            (at.LATEXSTR, r"\newpage"),
            (at.SKELETON, "Old/BinarySearchTreeNode.h"),
            (at.SKELETON, "Old/BinarySearchTreeNode.cpp"),
            (at.SKELETON, "Old/BinarySearchTree.h"),
            (at.SKELETON, "Old/BinarySearchTree.cpp"),
            (at.SKELETON, "Old/test.cpp"),
            (at.LATEXSTR, r"\newpage"),
            (at.QUEST_CODE, "Old/q02.tex"),
            (at.OTHER, "Old/Note.tex")
            ]
###########################################################################
