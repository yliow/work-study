...
# - name of file
contents = [(at.QUEST_CODE, "../../courses/ciss350/a/a07/questions/q01.tex"),
            (at.LATEXSTR, r"\newpage"),
            (at.OTHER, "../../courses/ciss350/a/a07/questions/cpp-stl-review.tex"),
            (at.LATEXSTR, r"\newpage"),
            # (at.DOCUMENTS, "../../courses/ciss350/a/a07/questions/stack.cpp"),
            # (at.LATEXSTR, r"\newpage"),
            # (at.DOCUMENTS, "../../courses/ciss350/a/a07/questions/queue.cpp"),
            # (at.LATEXSTR, r"\newpage"),
            # (at.DOCUMENTS, "../../courses/ciss350/a/a07/questions/list.cpp"),
            # (at.LATEXSTR, r"\newpage"),
            (at.QUEST_CODE, "../../courses/ciss350/a/a07/questions/q02.tex"),
            (at.LATEXSTR, r"\newpage"),
            (at.QUEST_CODE, "../../courses/ciss350/a/a07/questions/q03.tex"),
            (at.LATEXSTR, r"\newpage"),
            (at.QUEST_CODE, "../../courses/ciss350/a/a07/questions/q04.tex"),
            (at.LATEXSTR, r"\newpage"),
            (at.QUEST_CODE, "../../courses/ciss350/a/a07/questions/sparse-polynomial.tex"),
            (at.LATEXSTR, r"\newpage"),
            (at.QUEST_CODE, "../../courses/ciss350/a/a07/questions/infix-to-rpn.tex")
            ]
###########################################################################
