def makefile():
    ...
    \\ \n\t\'main.log\' \'main.aux\' \'main.toc\'
    \'main.out\' \'main.idx\' \'main.ilg\' \'main.vrb\'
    \'main.snm\' \'main.nav\' \\ \n\t\'main.py.err\'
    \'main.py.out\' \'main.py\' \'latex.py\' \'main.pytxcode\'
    \\ \n\t\'makefile.old\' \'missfont.log\' \'traceback.txt\'
    \nc:\n\tmake cleantmp\ns:\n\tmake cleantmp\n\n\trm -rf submit;
    rm -f submit.tar.gz; mkdir submit; rsync -av .
    submit --exclude submit; tar -cvf submit.tar submit;
     gzip submit.tar || true\n
    \t@echo
    \"================================================================\"\n
