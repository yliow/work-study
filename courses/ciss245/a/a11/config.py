...
contents = [(at.OTHER, "Old/objectives.tex"),
            ...
            (at.LATEXSTR, r"\newpage"),
            (at.OTHER, "Old/stl_vector.tex"),
            (at.LATEXSTR, r"\newpage"),
            (at.OTHER, "Old/unsigned_int.tex"),
            (at.LATEXSTR, r"\newpage"),
            (at.OTHER, "Old/test_code.tex"),
            (at.SKEL_PDF, "Old/testLongInt.cpp"),
            (at.LATEXSTR, r"\newpage"),
            (at.OTHER, "Old/typedef.tex"),
            (at.LATEXSTR, r"\newpage"),
            (at.OTHER, "Old/Spoilers.tex"),
            (at.LATEXSTR, r"\newpage"),
            (at.OTHER, "Old/Ultimate_Test_cases.tex"),
            (at.LATEXSTR, r"\newpage"),
            (at.OTHER, "Old/DIY.tex")
            ]
###########################################################################
