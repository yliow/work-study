...
contents = [(at.OTHER, "Old/objectives.tex"),
            ...
            (at.LATEXSTR, r"\newpage"),
            (at.QUEST_CODE, "Old/q13.tex"),
            (at.LATEXSTR, r"\newpage"),
            (at.QUEST_CODE, "Old/q14.tex"),
            (at.LATEXSTR, r"\newpage"),
            (at.OTHER, "Old/type_conversion_funct.tex"),
            (at.LATEXSTR, r"\newpage"),
            (at.QUEST_CODE, "Old/q15.tex"),
            (at.LATEXSTR, r"\newpage"),
            (at.QUEST_CODE, "Old/q16.tex"),
            (at.LATEXSTR, r"\newpage"),
            (at.QUEST_CODE, "Old/q17.tex"),
            (at.LATEXSTR, r"\newpage"),
            (at.QUEST_CODE, "Old/q18.tex"),
            (at.LATEXSTR, r"\newpage"),
            (at.QUEST_CODE, "Old/q19.tex"),
            (at.LATEXSTR, r"\newpage"),
            (at.QUEST_CODE, "Old/q20.tex"),
            (at.LATEXSTR, r"\newpage"),
            (at.OTHER, "Old/miscellaneous.tex"),
            ]
###########################################################################
