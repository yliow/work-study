%-*-latex-*-
\tinysidebar{\debug{discrete-probability/exercises/{prob-09/answer.tex}}}
...
\input{discrete-probability/stdout/stdout09a.tex}
...
\]
Here a program to check the above computation:
\input{discrete-probability/stdout/stdout09b.tex}
