%-*-latex-*-
\tinysidebar{\debug{discrete-probability/exercises/{prob-08/answer.tex}}}
...
\input{discrete-probability/stdout/stdout08a.tex}
...
Here's a program to check my computation:
\input{discrete-probability/stdout/stdout08b.tex}
...
Here's a program to check my computation:
\input{discrete-probability/stdout/stdout08c.tex}
