...
\node [line width=0.03cm,black,minimum size=0.6699999999999999cm,draw,circle] at (-2.38,-3.0)(9){};\draw (-2.38, -3.0) node[color=black] {\texttt{9}};\draw[line width=0.03cm,black] (1) to  (3);
\draw[line width=0.03cm,black] (1) to  (2);
\draw[line width=0.03cm,black] (3) to  (0);
\draw[line width=0.03cm,black] (3) to  (4);
...
\draw[line width=0.1cm,white] (3) to  (4);
\draw[line width=0.03cm,black,,dashed] (3) to  (4);
\end{tikzpicture}
