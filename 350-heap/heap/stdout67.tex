...
\node [line width=0.03cm,black,minimum size=0.6699999999999999cm,draw,circle] at (-2.38,-3.0)(9){};\draw (-2.38, -3.0) node[color=black] {\texttt{9}};\draw[line width=0.03cm,black] (0) to  (7);
...
\draw[line width=0.03cm,black] (6) to  (8);
...
\draw[line width=0.03cm,black] (-3.33, -3.0) circle (0.33499999999999996);\draw (-3.33, -3.0) node[color=black] {8};\draw[line width=0.1cm,white] (6) to  (9);
\draw[line width=0.03cm,black,,dashed] (6) to  (9);
\draw[line width=0.1cm,white] (6) to  (8);
\draw[line width=0.03cm,black,,dashed] (6) to  (8);
\end{tikzpicture}
