...
};\draw (0.3, -0.3) node[color=black] {{\texttt{6}}};
...
};\draw (0.8999999999999999, -0.3) node[color=black] {{\texttt{8}}};
\draw (1.5, -0.3)
  node[draw, line width=0.04cm, , color=black,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (2.0999999999999996, -0.3) node[color=black] {{\texttt{7}}};
\draw (2.7, -0.3)
  node[draw, line width=0.04cm, , color=black,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (5.1, -0.3) node[color=black] {{\texttt{9}}};\draw[line width=0.1cm,black] (4.82,-0.82) to  (4.82,0.22);
