...
\node [line width=0.03cm,black,minimum size=0.6699999999999999cm,draw,circle] at (-2.38,-3.0)(12){};\draw (-2.38, -3.0) node[color=black] {\texttt{12}};\draw[line width=0.03cm,black] (10) to  (9);
...
\draw[line width=0.03cm,black] (5) to  (12);
\end{tikzpicture}
