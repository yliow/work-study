...
\begin{center}
\begin{tikzpicture}
\draw[gray] (1.0,-3.0) to  (1.0,1.0);
\draw[gray] (2.0,-3.0) to  (2.0,1.0);
\draw[gray] (3.0,-3.0) to  (3.0,1.0);
\draw[gray] (4.0,-3.0) to  (4.0,1.0);
\draw[gray] (5.0,-3.0) to  (5.0,1.0);
\draw[gray] (6.0,-3.0) to  (6.0,1.0);
\draw[gray] (7.0,-3.0) to  (7.0,1.0);
\draw[gray] (8.0,-3.0) to  (8.0,1.0);
\draw[gray] (9.0,-3.0) to  (9.0,1.0);
\draw[gray] (10.0,-3.0) to  (10.0,1.0);
\draw[gray] (11.0,-3.0) to  (11.0,1.0);
\draw[gray] (1.0,-3.0) to  (11.0,-3.0);
\draw[gray] (1.0,-2.0) to  (11.0,-2.0);
\draw[gray] (1.0,-1.0) to  (11.0,-1.0);
\draw[gray] (1.0,0.0) to  (11.0,0.0);
\draw[gray] (1.0,1.0) to  (11.0,1.0);
...
\draw(5, -3) node [font=\ttfamily, label=below:{\normalsize {\texttt{5}}}] {};
\draw(6, -3) node [font=\ttfamily, label=below:{\normalsize {\texttt{6}}}] {};
\draw(7, -3) node [font=\ttfamily, label=below:{\normalsize {\texttt{7}}}] {};
\draw(8, -3) node [font=\ttfamily, label=below:{\normalsize {\texttt{8}}}] {};
\draw(9, -3) node [font=\ttfamily, label=below:{\normalsize {\texttt{9}}}] {};
\draw(10, -3) node [font=\ttfamily, label=below:{\normalsize {\texttt{10}}}] {};
\draw(11, -3) node [font=\ttfamily, label=below:{\normalsize {\texttt{11}}}] {};
...
};\draw (5.625, -2.125) node[color=black] {{\texttt{10}}};
\end{tikzpicture}
