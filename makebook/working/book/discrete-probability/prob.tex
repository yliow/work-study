...
\input{discrete-probability/exercises/discrete-probability/prob-08/main.tex}
\input{discrete-probability/exercises/discrete-probability/prob-09/main.tex}
...
\input{discrete-probability/stdout/stdout00.tex}
...
Here's my output when I run the program:
\input{discrete-probability/stdout/stdout01.tex}

\input{discrete-probability/exercises/discrete-probability/prob-00/main.tex}
...
Here's my output when I run the program:
\input{discrete-probability/stdout/stdout02.tex}
...
Here's my output when I run the program:
\input{discrete-probability/stdout/stdout03.tex}
...
\input{discrete-probability/exercises/discrete-probability/prob-01/main.tex}
\input{discrete-probability/exercises/discrete-probability/prob-02/main.tex}
\input{discrete-probability/exercises/discrete-probability/prob-03/main.tex}
...
\input{discrete-probability/exercises/discrete-probability/prob-04/main.tex}
\input{discrete-probability/exercises/discrete-probability/prob-05/main.tex}
...
\input{discrete-probability/exercises/discrete-probability/prob-06/main.tex}
