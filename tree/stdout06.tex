...
\node [line width=0.03cm,black,minimum size=0.57cm,draw,circle] at (3.5,-3.0)(m){};\draw (3.5, -3.0) node[color=black] {$m$};\draw[line width=0.03cm,black] (a) to  (b);
...
\draw[line width=0.03cm,black] (g) to  (l);
\draw[line width=0.03cm,black] (g) to  (m);
\end{tikzpicture}
