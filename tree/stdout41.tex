...
\node [line width=0.03cm,black,minimum size=0.57cm,draw,circle] at (13.0,0.0)(a){};\draw (13.0, 0.0) node[color=black] {\texttt{15}};
...
\node [line width=0.03cm,black,minimum size=0.57cm,draw,circle] at (14.0,-2.0)(m){};\draw (14.0, -2.0) node[color=black] {\texttt{17}};
\fill[white] (12.0, -2.0) circle (0.3);
\node [line width=0.03cm,black,minimum size=0.57cm,draw,circle] at (12.0,-2.0)(x){};\draw (12.0, -2.0) node[color=black] {\texttt{8}};\draw[line width=0.03cm,black,->,>=triangle 60] (a) to  (p);
...
\draw[line width=0.03cm,black,->,>=triangle 60] (b) to  (x);
