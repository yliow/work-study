...
\node [line width=0.03cm,black,,dashed,minimum size=0.57cm,draw,circle] at (16.0,-1.0)(a){};\draw (16.0, -1.0) node[color=black] {\texttt{10}};
\fill[white] (16.0, -1.7) circle (0.3);
\node [line width=0.03cm,black,minimum size=0.57cm,draw,circle] at (16.0,-1.7)(aa){};\draw (16.0, -1.7) node[color=black] {\texttt{8}};
...
\node [line width=0.03cm,black,minimum size=0.57cm,draw,circle] at (15.0,-6.0)(o){};\draw (15.0, -6.0) node[color=black] {\texttt{7}};\draw[line width=0.03cm,black,->,>=triangle 60] (A) to  (aa);
\draw[line width=0.03cm,black,->,>=triangle 60] (aa) to  (p);
\draw[line width=0.03cm,black,->,>=triangle 60] (aa) to  (b);
...
\draw[line width=0.03cm,black,->,>=triangle 60] (f) to  (m);
...
\draw[line width=0.03cm,black,->,>=triangle 60,dashed] (a) to  (p);
\draw[line width=0.03cm,black,->,>=triangle 60,dashed] (f) to  (h);
\draw[line width=0.03cm,black,->,>=triangle 60,dashed] (h) to  (m);
\draw[line width=0.03cm,black,->,>=triangle 60,dashed] (A) to  (a);
\draw[line width=0.03cm,black,->,>=triangle 60,dashed] (a) to  (b);
\draw[line width=0.2cm,black,->,>=triangle 60,dashed] (h) to  (aa);
\end{tikzpicture}
