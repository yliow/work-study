...
\node [line width=0.03cm,black,minimum size=0.57cm,draw,circle] at (0.0,0.0)(7){};\draw (0.0, 0.0) node[color=black] {\texttt{7}};
...
\node [line width=0.03cm,black,minimum size=0.57cm,draw,circle] at (-1.5,-2.0)(6){};\draw (-1.5, -2.0) node[color=black] {\texttt{6}};
\fill[white] (1.5, -2.0) circle (0.3);
\node [line width=0.03cm,black,minimum size=0.57cm,draw,circle] at (1.5,-2.0)(8){};\draw (1.5, -2.0) node[color=black] {\texttt{8}};
\fill[white] (4.5, -2.0) circle (0.3);
\node [line width=0.03cm,black,minimum size=0.57cm,draw,circle] at (4.5,-2.0)(18){};\draw (4.5, -2.0) node[color=black] {\texttt{18}};\draw[line width=0.03cm,black,->,>=triangle 60] (10) to  (8);
...
\draw[line width=0.03cm,black,->,>=triangle 60] (7) to  (5);
\draw[line width=0.03cm,black,->,>=triangle 60] (7) to  (10);
\end{tikzpicture}
