...
\fill[blue!10] (2.5, -3.0) circle (0.3);
\node [line width=0.03cm,black,minimum size=0.57cm,draw,circle] at (2.5,-3.0)(p){};\draw (2.5, -3.0) node[color=black] {$p$};
\fill[blue!10] (3.5, -3.0) circle (0.3);
...
\draw[line width=0.03cm,black,->,>=triangle 60] (o) to  (p);
\draw[line width=0.03cm,black,->,>=triangle 60] (o) to  (j);

\fill[blue!10] (2.1, -4.0) circle (0.3);
\node [line width=0.03cm,black,minimum size=0.57cm,draw,circle] at (2.1,-4.0)(q){};\draw (2.1, -4.0) node[color=black] {$q$};
\fill[blue!10] (2.9, -4.0) circle (0.3);
\node [line width=0.03cm,black,minimum size=0.57cm,draw,circle] at (2.9,-4.0)(r){};\draw (2.9, -4.0) node[color=black] {$r$};\draw[line width=0.03cm,black,->,>=triangle 60] (p) to  (q);
