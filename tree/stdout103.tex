...
\node [line width=0.03cm,black,minimum size=0.57cm,draw,circle] at (-3.0,-1.0)(7){};\draw (-3.0, -1.0) node[color=black] {\texttt{7}};
\fill[white] (3.0, -1.0) circle (0.3);
...
\node [line width=0.03cm,black,minimum size=0.57cm,draw,circle] at (-4.5,-2.0)(5){};\draw (-4.5, -2.0) node[color=black] {\texttt{5}};
...
\node [line width=0.03cm,black,minimum size=0.57cm,draw,circle] at (-3.75,-3.0)(6){};\draw (-3.75, -3.0) node[color=black] {\texttt{6}};\draw[line width=0.03cm,black,->,>=triangle 60] (10) to  (7);
