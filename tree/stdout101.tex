...
\node [line width=0.03cm,black,minimum size=0.57cm,draw,circle] at (-3.0,-1.0)(0){};\draw (-3.0, -1.0) node[color=black] {\texttt{0}};
\fill[white] (3.0, -1.0) circle (0.3);
...
\node [line width=0.03cm,black,minimum size=0.57cm,draw,circle] at (0.75,-3.0)(6){};\draw (0.75, -3.0) node[color=black] {\texttt{6}};
\fill[white] (2.25, -3.0) circle (0.3);
\node [line width=0.03cm,black,minimum size=0.57cm,draw,circle] at (2.25,-3.0)(8){};\draw (2.25, -3.0) node[color=black] {\texttt{8}};\draw[line width=0.03cm,black,->,>=triangle 60] (10) to  (7);
