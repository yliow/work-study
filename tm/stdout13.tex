...
};\draw (0.49999999999999994, 0.49999999999999994) node[color=black] {\texttt{a}};
...
};\draw (1.5, 0.49999999999999994) node[color=black] {\texttt{b}};
...
};\draw (2.5, 0.49999999999999994) node[color=black] {\texttt{a}};
...
};\draw (4.5, 0.49999999999999994) node[color=black] {\texttt{$\sqcup$}};
...
};\draw (7.5, 0.49999999999999994) node[color=black] {\texttt{$\sqcup$}};
...
};\draw (8.5, 0.49999999999999994) node[color=black] {\texttt{$\sqcup$}};\draw[line width=0.01cm,black] (9.0,1.0) to  (9.5,1.0);
\draw[line width=0.01cm,black] (9.0,0.0) to  (9.5,0.0);
\end{tikzpicture}
