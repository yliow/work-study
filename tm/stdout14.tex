...
};\draw (0.49999999999999994, 0.49999999999999994) node[color=black] {\texttt{$\BOT$}};
...
};\draw (9.5, 0.49999999999999994) node[color=black] {\texttt{$\sqcup$}};
\draw (0.49999999999999994, 0.49999999999999994)
  node[draw, line width=0.01cm, , color=black,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (9.5, 0.49999999999999994) node[color=black] {\texttt{$\sqcup$}};\draw[line width=0.01cm,black] (10.0,1.0) to  (10.5,1.0);
\draw[line width=0.01cm,black] (10.0,0.0) to  (10.5,0.0);
\end{tikzpicture}
