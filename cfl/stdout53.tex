...
};\draw (0.2, -4.35) node[color=black] {{\vphantom{aa\$aabb\SPACE}\texttt{a}}};
...
};\draw (0.6000000000000001, -4.35) node[color=black] {{\vphantom{aa\$aabb\SPACE}\texttt{a}}};
\draw (1.0, -4.35)
  node[draw, line width=0.02cm, , color=black,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (1.0, -4.35) node[color=black] {{\vphantom{aa\$aabb\SPACE}\texttt{b}}};
...
};\draw (1.4000000000000001, -4.35) node[color=black] {{\vphantom{aa\$aabb\SPACE}\texttt{b}}};
...
};\draw (1.7999999999999998, -4.35) node[color=black] {{\vphantom{aa\$aabb\SPACE}\texttt{\SPACE}}};\draw[line width=0.02cm,black] (2.0,-4.1499999999999995) to  (2.2,-4.1499999999999995);
...
};\draw (1.45, -6.300000000000001) node[color=black] {{\vphantom{aa\$aabb\SPACE}\texttt{a}}};
...
};\draw (1.45, -6.700000000000001) node[color=black] {{\vphantom{aa\$aabb\SPACE}\texttt{a}}};
\draw (1.45, -7.100000000000001)
  node[draw, line width=0.02cm, , color=black,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (1.45, -7.100000000000001) node[color=black] {{\vphantom{aa\$aabb\SPACE}\texttt{\$}}};\draw[line width=0.02cm,black] (1.15,-5.75) to  (1.15,-7.4) to  (1.75,-7.4) to  (1.75,-5.75);
...
\draw[line width=0.05cm,black,->] (2.45,-4.55) to  (2.95,-4.55);

\draw (3.4000000000000004, -4.35)
  node[draw, line width=0.02cm, , color=black,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (3.4000000000000004, -4.35) node[color=black] {{\vphantom{a\$aabb\SPACE}\texttt{a}}};
\draw (3.8, -4.35)
  node[draw, line width=0.02cm, , color=black,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (3.8, -4.35) node[color=black] {{\vphantom{a\$aabb\SPACE}\texttt{a}}};
\draw (4.2, -4.35)
  node[draw, line width=0.02cm, , color=black,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (4.2, -4.35) node[color=black] {{\vphantom{a\$aabb\SPACE}\texttt{b}}};
\draw (4.6000000000000005, -4.35)
  node[draw, line width=0.02cm, , color=black,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (4.6000000000000005, -4.35) node[color=black] {{\vphantom{a\$aabb\SPACE}\texttt{b}}};
\draw (5.000000000000001, -4.35)
  node[draw, line width=0.02cm, , color=black,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (5.000000000000001, -4.35) node[color=black] {{\vphantom{a\$aabb\SPACE}\texttt{\SPACE}}};\draw[line width=0.02cm,black] (5.200000000000001,-4.1499999999999995) to  (5.4,-4.1499999999999995);
\draw[line width=0.02cm,black] (5.200000000000001,-4.55) to  (5.4,-4.55);
...
};\draw (3.7, -5.4) node[color=black] {$q_2$};\draw[line width=0.02cm,black,->] (3.7,-5.05) to  (3.7,-4.89) to  (4.6,-4.89) to  (4.6,-4.56);

\draw (4.65, -6.300000000000001)
  node[draw, line width=0.02cm, , color=black,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (4.65, -6.300000000000001) node[color=black] {{\vphantom{a\$aabb\SPACE}\texttt{a}}};
\draw (4.65, -6.700000000000001)
  node[draw, line width=0.02cm, , color=black,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (4.65, -6.700000000000001) node[color=black] {{\vphantom{a\$aabb\SPACE}\texttt{\$}}};\draw[line width=0.02cm,black] (4.35,-5.75) to  (4.35,-7.0) to  (4.95,-7.0) to  (4.95,-5.75);
\draw[line width=0.02cm,black] (4.2,-5.4) to  (4.65,-5.4) to  (4.65,-5.75);
\draw[line width=0.02cm,black] (4.45,-5.95) to  (4.45,-5.75) to  (4.85,-5.75) to  (4.85,-5.95);
\draw[line width=0.05cm,black,->] (5.65,-4.55) to  (6.15,-4.55);

\draw (6.600000000000001, -4.35)
  node[draw, line width=0.02cm, , color=black,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (6.600000000000001, -4.35) node[color=black] {{\vphantom{\$aabb\SPACE}\texttt{a}}};
\draw (7.000000000000002, -4.35)
  node[draw, line width=0.02cm, , color=black,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (7.000000000000002, -4.35) node[color=black] {{\vphantom{\$aabb\SPACE}\texttt{a}}};
\draw (7.400000000000002, -4.35)
  node[draw, line width=0.02cm, , color=black,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (7.400000000000002, -4.35) node[color=black] {{\vphantom{\$aabb\SPACE}\texttt{b}}};
\draw (7.8000000000000025, -4.35)
  node[draw, line width=0.02cm, , color=black,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (7.8000000000000025, -4.35) node[color=black] {{\vphantom{\$aabb\SPACE}\texttt{b}}};
\draw (8.200000000000003, -4.35)
  node[draw, line width=0.02cm, , color=black,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (8.200000000000003, -4.35) node[color=black] {{\vphantom{\$aabb\SPACE}\texttt{\SPACE}}};\draw[line width=0.02cm,black] (8.400000000000002,-4.1499999999999995) to  (8.600000000000001,-4.1499999999999995);
\draw[line width=0.02cm,black] (8.400000000000002,-4.55) to  (8.600000000000001,-4.55);

\draw (6.900000000000001, -5.4)
  node[draw, line width=0.02cm, , color=black,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (6.900000000000001, -5.4) node[color=black] {$q_2$};\draw[line width=0.02cm,black,->] (6.9,-5.05) to  (6.9,-4.89) to  (8.2,-4.89) to  (8.2,-4.56);

\draw (7.850000000000001, -6.300000000000001)
  node[draw, line width=0.02cm, , color=black,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (7.850000000000001, -6.300000000000001) node[color=black] {{\vphantom{\$aabb\SPACE}\texttt{\$}}};\draw[line width=0.02cm,black] (7.55,-5.75) to  (7.55,-6.6) to  (8.15,-6.6) to  (8.15,-5.75);
\draw[line width=0.02cm,black] (7.4,-5.4) to  (7.85,-5.4) to  (7.85,-5.75);
\draw[line width=0.02cm,black] (7.65,-5.95) to  (7.65,-5.75) to  (8.05,-5.75) to  (8.05,-5.95);
\draw[line width=0.05cm,black,->] (8.85,-4.55) to  (9.35,-4.55);
...
};\draw (9.8, -4.35) node[color=black] {{\vphantom{aabb\SPACE}\texttt{a}}};
\draw (10.200000000000003, -4.35)
  node[draw, line width=0.02cm, , color=black,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (10.200000000000003, -4.35) node[color=black] {{\vphantom{aabb\SPACE}\texttt{a}}};
\draw (10.600000000000001, -4.35)
  node[draw, line width=0.02cm, , color=black,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (10.600000000000001, -4.35) node[color=black] {{\vphantom{aabb\SPACE}\texttt{b}}};
\draw (11.000000000000004, -4.35)
  node[draw, line width=0.02cm, , color=black,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (11.000000000000004, -4.35) node[color=black] {{\vphantom{aabb\SPACE}\texttt{b}}};
\draw (11.400000000000002, -4.35)
  node[draw, line width=0.02cm, , color=black,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (11.400000000000002, -4.35) node[color=black] {{\vphantom{aabb\SPACE}\texttt{\SPACE}}};\draw[line width=0.02cm,black] (11.600000000000003,-4.1499999999999995) to  (11.800000000000002,-4.1499999999999995);
\draw[line width=0.02cm,black] (11.600000000000003,-4.55) to  (11.800000000000002,-4.55);

\draw (10.100000000000001, -5.4)
  node[draw, line width=0.02cm, , color=black,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (10.100000000000001, -5.4) node[color=black] {$q_3$};\draw[line width=0.02cm,black,->] (10.1,-5.05) to  (10.1,-4.89) to  (11.4,-4.89) to  (11.4,-4.56);

\draw (11.05, -6.300000000000001)
  node[draw=none, line width=0cm, , color=black,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw[line width=0.02cm,black] (10.75,-5.75) to  (10.75,-6.6) to  (11.35,-6.6) to  (11.35,-5.75);
\draw[line width=0.02cm,black] (10.6,-5.4) to  (11.05,-5.4) to  (11.05,-5.75);
\draw[line width=0.02cm,black] (10.85,-5.95) to  (10.85,-5.75) to  (11.25,-5.75) to  (11.25,-5.95);
\end{tikzpicture}
