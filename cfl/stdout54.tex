...
};\draw (9.8, 0.2) node[color=black] {{\vphantom{a\$aabb\SPACE}\texttt{a}}};
...
};\draw (10.200000000000003, 0.2) node[color=black] {{\vphantom{a\$aabb\SPACE}\texttt{a}}};
...
};\draw (10.600000000000001, 0.2) node[color=black] {{\vphantom{a\$aabb\SPACE}\texttt{b}}};
...
};\draw (11.000000000000004, 0.2) node[color=black] {{\vphantom{a\$aabb\SPACE}\texttt{b}}};
...
};\draw (11.400000000000002, 0.2) node[color=black] {{\vphantom{a\$aabb\SPACE}\texttt{\SPACE}}};\draw[line width=0.02cm,black] (11.600000000000003,0.4) to  (11.800000000000002,0.4);
...
};\draw (10.100000000000001, -0.85) node[color=black] {$q_2$};\draw[line width=0.02cm,black,->] (10.1,-0.5) to  (10.1,-0.34) to  (10.2,-0.34) to  (10.2,-0.01);
...
};\draw (11.05, -1.7499999999999998) node[color=black] {{\vphantom{a\$aabb\SPACE}\texttt{a}}};
...
};\draw (11.05, -2.1499999999999995) node[color=black] {{\vphantom{a\$aabb\SPACE}\texttt{\$}}};\draw[line width=0.02cm,black] (10.75,-1.2) to  (10.75,-2.45) to  (11.35,-2.45) to  (11.35,-1.2);
