...
\draw (3.45, -1.0499999999999998) node[color=black,
 inner sep=0.2cm] {
...
\draw (5.800000000000001, 0.8750000000000001)
  node[draw, line width=0.1cm, , color=white,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (5.800000000000001, 0.8750000000000001) node[color=black] {{\texttt{a}}};
\draw (8.125, 0.8750000000000001)
  node[draw, line width=0.1cm, , color=white,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (8.125, 0.8750000000000001) node[color=black] {{\texttt{a}}};
...
};\draw (12.725000000000001, 0.8750000000000001) node[color=black] {{\texttt{b}}};\draw[line width=0.1cm,black,->] (1.15,-0.35) to  (1.15,-1.05);
\draw[line width=0.1cm,black,->] (3.45,-1.05) to  (5.75,-0.35);
\end{tikzpicture}
