...
};\draw (8.125, 0.85) node[color=black] {{\texttt{a}}};
\draw (10.450000000000001, 0.85)
  node[draw, line width=0.1cm, , color=white,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (10.450000000000001, 0.85) node[color=black] {{\texttt{a}}};
...
};\draw (12.750000000000002, 0.85) node[color=black] {{\texttt{b}}};\draw[line width=0.1cm,black,->] (3.45,-0.35) to  (3.45,-1.05);
\draw[line width=0.1cm,black,->] (5.75,-1.05) to  (8.05,-0.35);
\end{tikzpicture}
