...
};\draw (8.075, 0.8750000000000001) node[color=black] {{\texttt{a}}};
\draw (10.375, 0.8750000000000001)
  node[draw, line width=0.1cm, , color=white,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (10.375, 0.8750000000000001) node[color=black] {{\texttt{a}}};
\draw (12.675, 0.8750000000000001)
  node[draw, line width=0.1cm, , color=white,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (12.675, 0.8750000000000001) node[color=black] {{\texttt{b}}};
\end{tikzpicture}
