...
};\draw (5.775, 0.85) node[color=black] {{\texttt{a}}};
...
};\draw (10.4, 0.85) node[color=black] {{\texttt{a}}};
\draw (12.725000000000001, 0.85)
  node[draw, line width=0.1cm, , color=white,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (12.725000000000001, 0.85) node[color=black] {{\texttt{b}}};
\end{tikzpicture}
