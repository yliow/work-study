...
};\draw (3.4000000000000004, 0.2) node[color=black] {{\vphantom{\$\SPACE\SPACE\SPACE\SPACE\SPACE}\texttt{\SPACE}}};
\draw (3.8, 0.2)
  node[draw, line width=0.02cm, , color=black,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (3.8, 0.2) node[color=black] {{\vphantom{\$\SPACE\SPACE\SPACE\SPACE\SPACE}\texttt{\SPACE}}};
\draw (4.2, 0.2)
  node[draw, line width=0.02cm, , color=black,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (4.2, 0.2) node[color=black] {{\vphantom{\$\SPACE\SPACE\SPACE\SPACE\SPACE}\texttt{\SPACE}}};
...
};\draw (4.6000000000000005, 0.2) node[color=black] {{\vphantom{\$\SPACE\SPACE\SPACE\SPACE\SPACE}\texttt{\SPACE}}};
...
};\draw (5.000000000000001, 0.2) node[color=black] {{\vphantom{\$\SPACE\SPACE\SPACE\SPACE\SPACE}\texttt{\SPACE}}};\draw[line width=0.02cm,black] (5.200000000000001,0.4) to  (5.4,0.4);
...
};\draw (4.65, -1.7499999999999998) node[color=black] {{\vphantom{\$\SPACE\SPACE\SPACE\SPACE\SPACE}\texttt{\$}}};\draw[line width=0.02cm,black] (4.35,-1.2) to  (4.35,-2.05) to  (4.95,-2.05) to  (4.95,-1.2);
