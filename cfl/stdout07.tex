...
\draw (3.45, -0.35) node[color=black,
 inner sep=0.2cm] {
...
};\draw (3.5, 0.8750000000000001) node[color=black] {{\texttt{a}}};
\draw (5.824999999999999, 0.8750000000000001)
  node[draw, line width=0.1cm, , color=white,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (5.824999999999999, 0.8750000000000001) node[color=black] {{\texttt{a}}};
...
\draw (10.424999999999999, 0.8750000000000001)
  node[draw, line width=0.1cm, , color=white,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (10.424999999999999, 0.8750000000000001) node[color=black] {{\texttt{a}}};
\draw (12.725, 0.8750000000000001)
  node[draw, line width=0.1cm, , color=white,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (12.725, 0.8750000000000001) node[color=black] {{\texttt{b}}};
\end{tikzpicture}
