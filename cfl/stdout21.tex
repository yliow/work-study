...
\draw (1.15, -0.35)
  node[fill=blue!10,rounded corners=0cm,inner sep=0.2cm] {
...
\draw (8.049999999999999, -0.35)
  node[fill=green!10,rounded corners=0cm,inner sep=0.2cm] {
...
\draw (1.15, -1.0499999999999998)
  node[fill=red!10,rounded corners=0cm,inner sep=0.2cm] {
...
\draw (3.45, -1.7499999999999996) node[color=black,
 inner sep=0.2cm] {
...
};\draw[line width=0.08cm,black] (-0.03,0.03) to  (-1.02,1.02);
\node[anchor=north east] at (-0.525,0.525) {$j$};\node[anchor=south west] at (-0.525,0.525) {$i$};
\draw (1.1499999999999997, 0.8750000000000001)
  node[draw, line width=0.1cm, , color=white,
       rounded corners=0cm, inner sep=0cm] {

\begin{minipage}[t][0.7cm]{2.35cm}
\mbox{}

\end{minipage}

};\draw (1.1499999999999997, 0.8750000000000001) node[color=black] {{\texttt{b}}};
\draw (3.4749999999999996, 0.8750000000000001)
  node[draw, line width=0.1cm, , color=white,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (3.4749999999999996, 0.8750000000000001) node[color=black] {{\texttt{a}}};
\draw (5.775, 0.8750000000000001)
  node[draw, line width=0.1cm, , color=white,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (5.775, 0.8750000000000001) node[color=black] {{\texttt{a}}};
\draw (8.100000000000001, 0.8750000000000001)
  node[draw, line width=0.1cm, , color=white,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (8.100000000000001, 0.8750000000000001) node[color=black] {{\texttt{a}}};
\draw (10.425, 0.8750000000000001)
  node[draw, line width=0.1cm, , color=white,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (10.425, 0.8750000000000001) node[color=black] {{\texttt{a}}};
\draw (12.725000000000001, 0.8750000000000001)
  node[draw, line width=0.1cm, , color=white,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (12.725000000000001, 0.8750000000000001) node[color=black] {{\texttt{b}}};\draw[line width=0.1cm,black,->] (1.15,-0.35) to  (1.15,-1.75);
\draw[line width=0.1cm,black,->] (3.45,-1.75) to  (8.05,-0.35);
\end{tikzpicture}
