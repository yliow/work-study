...
};\draw (3.475, 0.85) node[color=black] {{\texttt{a}}};
\draw (5.800000000000001, 0.85)
  node[draw, line width=0.1cm, , color=white,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (5.800000000000001, 0.85) node[color=black] {{\texttt{a}}};
\draw (8.100000000000001, 0.85)
  node[draw, line width=0.1cm, , color=white,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (8.100000000000001, 0.85) node[color=black] {{\texttt{a}}};
\draw (10.425, 0.85)
  node[draw, line width=0.1cm, , color=white,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (10.425, 0.85) node[color=black] {{\texttt{a}}};
\draw (12.750000000000002, 0.85)
  node[draw, line width=0.1cm, , color=white,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (12.750000000000002, 0.85) node[color=black] {{\texttt{b}}};
\end{tikzpicture}
