...
};\draw (5.825000000000001, 0.85) node[color=black] {{\texttt{a}}};
\draw (8.150000000000002, 0.85)
  node[draw, line width=0.1cm, , color=white,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (8.150000000000002, 0.85) node[color=black] {{\texttt{a}}};
