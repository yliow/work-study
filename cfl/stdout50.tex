...
};\draw (0.5, -5.4) node[color=black] {$q_2$};\draw[line width=0.02cm,black,->] (0.5,-5.05) to  (0.5,-4.89) to  (1.4,-4.89) to  (1.4,-4.56);
...
};\draw (3.4000000000000004, -4.35) node[color=black] {{\vphantom{\$aabb\SPACE}\texttt{a}}};
\draw (3.8, -4.35)
  node[draw, line width=0.02cm, , color=black,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (3.8, -4.35) node[color=black] {{\vphantom{\$aabb\SPACE}\texttt{a}}};
\draw (4.2, -4.35)
  node[draw, line width=0.02cm, , color=black,
       rounded corners=0cm, inner sep=0cm] {
...
};\draw (4.2, -4.35) node[color=black] {{\vphantom{\$aabb\SPACE}\texttt{b}}};
...
};\draw (4.6000000000000005, -4.35) node[color=black] {{\vphantom{\$aabb\SPACE}\texttt{b}}};
...
};\draw (5.000000000000001, -4.35) node[color=black] {{\vphantom{\$aabb\SPACE}\texttt{\SPACE}}};\draw[line width=0.02cm,black] (5.200000000000001,-4.1499999999999995) to  (5.4,-4.1499999999999995);
...
};\draw (3.7, -5.4) node[color=black] {$q_2$};\draw[line width=0.02cm,black,->] (3.7,-5.05) to  (3.7,-4.89) to  (5.0,-4.89) to  (5.0,-4.56);
...
};\draw (4.65, -6.300000000000001) node[color=black] {{\vphantom{\$aabb\SPACE}\texttt{\$}}};\draw[line width=0.02cm,black] (4.35,-5.75) to  (4.35,-6.6) to  (4.95,-6.6) to  (4.95,-5.75);
...
};\draw (6.900000000000001, -5.4) node[color=black] {$q_3$};\draw[line width=0.02cm,black,->] (6.9,-5.05) to  (6.9,-4.89) to  (8.2,-4.89) to  (8.2,-4.56);
...
};\draw[line width=0.02cm,black] (7.55,-5.75) to  (7.55,-6.6) to  (8.15,-6.6) to  (8.15,-5.75);
